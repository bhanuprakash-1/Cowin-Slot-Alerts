...
const cowinSlots = new CowinSlots();
const globalEventObject = new EventEmitter();

globalEventObject.on("smsBody",(smsBody)=>{

    console.log("Debug: Okay reached event listener on ....smsBody...");
...
app.listen(3000, function() {
    ...
    setInterval(cowinSlots.getSlotsforDistrictID, 5000,'581',globalEventObject);
});